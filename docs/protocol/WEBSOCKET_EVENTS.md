...
Event types: `MACHINE_CONNECTED`, `MACHINE_DISCONNECTED`, `MACHINE_STATE_CHANGED`, `COMMAND_ACKNOWLEDGED`, `DELIVERY_STARTED`, `DELIVERY_COMPLETED`, `DELIVERY_FAILED`, `SESSION_STARTED`, `SESSION_COMPLETED`, `FAULT`, `EMERGENCY_STOP`, `HEARTBEAT`, `STATUS_UPDATED`.
